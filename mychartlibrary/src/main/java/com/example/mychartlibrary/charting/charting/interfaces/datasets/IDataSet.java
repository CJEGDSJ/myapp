package com.example.mychartlibrary.charting.charting.interfaces.datasets;

import android.graphics.DashPathEffect;
import android.graphics.Typeface;

import com.example.mychartlibrary.charting.charting.data.BarEntry;
import com.example.mychartlibrary.charting.charting.components.Legend;
import com.example.mychartlibrary.charting.charting.components.YAxis;
import com.example.mychartlibrary.charting.charting.data.DataSet;
...
public interface IDataSet<T extends Entry> {
     ...
     * @return
     */
    BarEntry getEntryForIndex(int index);
